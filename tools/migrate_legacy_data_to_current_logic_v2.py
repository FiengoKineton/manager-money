...
try:
    ...
    PENDING_FIELDS = ["id", "type", "date_due", "amount", "category", "account", "description", "status", "source", "source_id", "pending_kind", "account_key", "account_label", "statement_month", "date_charge", "account_id", "account_name_snapshot", "payment_method_id", "payment_method_name_snapshot", "payment_resolution_template_json"]
