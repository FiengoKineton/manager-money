...
USER_JSON_DEFINITIONS: tuple[DataFileDefinition, ...] = (
    ...
    _json("timeline_events", "timeline_events.json", _config_default("timeline_events.json"), description="Timeline, audit and payment-history events for linked records.", sensitive="financial", encrypted_by_default=True),
    _json("account_reconciliation", "account_reconciliation.json", _config_default("account_reconciliation.json"), description="Manual real-bank balance checkpoints used to reconcile app balances.", sensitive="financial", encrypted_by_default=True),
    _json("smart_rules", "smart_rules.json", _config_default("smart_rules.json"), description="Rule-based automation used to classify and link transactions.", sensitive="financial", encrypted_by_default=True),
