...
FEATURES: dict[str, FeatureSpec] = {
    "overview": FeatureSpec(
        ...
        route_module="money_manager.web.routes.core.dashboard",
        blueprint="dashboard",
    ...
    "transactions": FeatureSpec(
        ...
        group="core",
        label="Transactions",
        route_module="money_manager.web.routes.core.transactions",
    ...
    "analysis": FeatureSpec(
        ...
        group="core",
        label="Analysis",
        route_module="money_manager.web.routes.core.analysis",
        blueprint="analysis",
    ...
    "pending": FeatureSpec(
        ...
        route_module="money_manager.web.routes.planning.pending",
        blueprint="pending",
    ...
    "forecast": FeatureSpec(
        ...
        group="planning",
        label="Forecast",
        route_module="money_manager.web.routes.planning.forecast",
        blueprint="forecast",
    ...
    "debts": FeatureSpec(
        ...
        group="planning",
        label="Debts I Owe",
        route_module="money_manager.web.routes.support.debts",
        blueprint="debts",
    ...
    "payables": FeatureSpec(
        ...
        group="planning",
        label="Payables",
        route_module="money_manager.web.routes.planning.payables",
        blueprint="payables",
    ...
    "expense_projects": FeatureSpec(
        ...
        route_module="money_manager.web.routes.planning.expense_projects",
    ...
    "accounts": FeatureSpec(
        ...
        route_module="money_manager.web.routes.accounts.accounts",
        blueprint="accounts",
    ...
    "internal_transfers": FeatureSpec(
        ...
        route_module="money_manager.web.routes.accounts.internal_transfers",
    ...
    "currencies": FeatureSpec(
        ...
        route_module="money_manager.web.routes.accounts.currencies",
    ...
    "investments": FeatureSpec(
        ...
        group="assets",
        label="Investments",
        route_module="money_manager.web.routes.assets.investments",
    ...
    "receivables": FeatureSpec(
        ...
        route_module="money_manager.web.routes.support.receivables",
    ...
    "sparagnat": FeatureSpec(
        ...
        route_module="money_manager.web.routes.support.sparagnat",
        blueprint="sparagnat",
    ...
    "parent_support": FeatureSpec(
        ...
        route_module="money_manager.web.routes.support.parent_support",
    ...
    "documents": FeatureSpec(
        ...
        group="support",
        label="Documents",
        route_module="money_manager.web.routes.support.documents",
        blueprint="documents",
