...
CACHE_DEFINITIONS: dict[str, CacheDefinition] = {
    ...
    "quick_overview": _def("quick_overview", "v5", "Small fast overview cards.", ("transactions", "ledger", "accounts", "pending", "internal_transfers"), ttl=SHORT_TTL_SECONDS, rebuild="money_manager.services.dashboard_calculation_service.get_quick_overview_uncached"),
    ...
    "scope_balance_summary": _def("scope_balance_summary", "v6", "Scoped net/pending summary for topbar and account pills.", ("transactions", "ledger", "accounts", "payment_methods", "internal_transfers", "credit_settlements", "pending", "payables", "recurring"), ttl=SHORT_TTL_SECONDS),
